class ReviewsController < ApplicationController
  def index
    ...
    @reviews = @q.result(:distinct => true).includes(:restaurant, :rating, :responses, :userprofile).page(params[:page]).per(10)
  ...
  def create
    ...
    @review.first_name = params[:first_name]
    @review.last_initial = params[:last_initial]
    @review.restaurant_id = params[:restaurant_id]
    @review.userprofile_id = params[:userprofile_id]
